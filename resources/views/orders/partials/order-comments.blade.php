@php
    $customerComments = getCustomerCommentsOrderStatusHistory($order->entity_id, 1, 1);
@endphp
    ...
    <table class="table table-bordered table-striped statement-table">
        <thead>
            <tr class="statement-row">
                <th class="statement-th col-3 min-width-50 greenshade printfont">Customer Notes</th> 
            </tr>
        </thead>
    @foreach ($customerComments as $customerComment)
        <tbody>
            <tr class="statement-row">
                <td class="statement-td ordertotal-info high-lightbg lnh-20 printfonttd" data-label="Order Total">
