...
class VanguardServiceProvider extends BaseVanguardServiceProvider {
    ...
    protected function plugins(): array {
        return [
            ...
            \Vanguard\Support\Plugins\Order::class,
            \Vanguard\Support\Plugins\OldOrder::class,
            \Vanguard\Support\Plugins\Addons::class,
            \Vanguard\Support\Plugins\OrderReportStatus::class,
            \Vanguard\Support\Plugins\RunningOrders::class, 
