...
use Vanguard\Http\Controllers\Web\OrderController;
...
//Route::get('api/order/show/{id}', 'Order\OrderController@show')->name('order.show');
...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    //Route::apiResource('orders', Order\OrderController::class);
});
